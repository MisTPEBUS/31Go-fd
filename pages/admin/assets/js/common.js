...
const DEFAULT_DATA = {
  spots: [
    {
      ...
      code: "SPOT-001",
      status: "enabled",
      url: `${LIFF_BASE_URL}?spot=SPOT-001`,
    },
    {
      id: "SPOT-ID-002",
      name: "新北市美術館",
      code: "SPOT-002",
      status: "enabled",
      url: `${LIFF_BASE_URL}?spot=SPOT-002`,
    },
    {
      id: "SPOT-ID-003",
      name: "新北市客家文化館",
      code: "SPOT-003",
      status: "disabled",
      url: `${LIFF_BASE_URL}?spot=SPOT-003`,
    },
  ],
  members: [
    {
      ...
      name: "王小明",
      phone: "0912-345-678",
      activityCode: "ACT-2026-0001",
      role: "member",
      checkins: 3,
      rewardStatus: "completed_unclaimed",
    },
    {
      id: "MEM-0002",
      name: "林小美",
      phone: "0922-111-222",
      activityCode: "ACT-2026-0002",
      role: "staff",
      checkins: 2,
  ...
  orders: [
    {
      orderNo: "ORD-20260606-001",
      buyer: "王小明",
      phone: "0912-345-678",
      activityCode: "ACT-2026-0001",
      paidStatus: "paid",
      redeemStatus: "completed_unclaimed",
      createdAt: "2026-06-06",
    },
    {
      orderNo: "ORD-20260606-002",
      buyer: "林小美",
      phone: "0922-111-222",
      activityCode: "ACT-2026-0002",
      paidStatus: "paid",
...
function showModal(type, title, message) {
  ...
  $("#modalIcon").className =
    `mx-auto flex h-16 w-16 items-center justify-center rounded-full text-2xl font-black ${isSuccess ? "bg-emerald-100 text-emerald-600" : "bg-red-100 text-red-600"}`;
